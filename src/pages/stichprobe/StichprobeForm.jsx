...
// Reusable section component for each inspection category
const Section = ({ title, checks, sectionKey, data, handleCheck, handleRemark }) => {
  return (
...
const StichprobeForm = ({ clickedItem }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const filledForm = {status, formData, basic: {artikelnr: clickedItem["Artikel-Nr. fertig"], firma: clickedItem["firma"], orderNumber:clickedItem["orderNumber"]}, mitarbeiter:mitarbeiter}
    ...
    <form className="stichprobe-form" onSubmit={handleSubmit}>
      <div className="populated-data">
        <div className="basic-info">
          ...
          <p className='artikel-nr-stichprobe'>{clickedItem["Artikel-Nr. fertig"]}</p>
          <p>{clickedItem["orderNumber"]}</p>
        </div>
      </div>

      <Section title="Allgemein" sectionKey="allgemein" data={formData.allgemein} handleCheck={handleCheck} handleRemark={handleRemark} checks={[
      ...
      <Section title="Oberfläche" sectionKey="oberflaeche" data={formData.oberflaeche} handleCheck={handleCheck} handleRemark={handleRemark} checks={[
      ...
      <Section title="Maße" sectionKey="masse" data={formData.masse} handleCheck={handleCheck} handleRemark={handleRemark} checks={[
        'Maße stimmen mit dem PIS überein (in Toleranzbereich)',
        'Goldgewicht im Toleranzbereich'
      ]} />

      <Section title="Mechanik" sectionKey="mechanik" data={formData.mechanik} handleCheck={handleCheck} handleRemark={handleRemark} checks={[
        'Bewegliche Elemente sind beweglich',
        'Keine offenen Links'
      ]} />

      <Section title="Steine" sectionKey="steine" data={formData.steine} handleCheck={handleCheck} handleRemark={handleRemark} checks={[
      ...
      <Section title="Weiterer Verlauf" sectionKey="weiter" data={formData.weiter} handleCheck={handleCheck} handleRemark={handleRemark} checks={[
        'Qualität genehmigt',
