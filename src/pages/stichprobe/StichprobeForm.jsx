...
const StichprobeForm = ({ clickedItem = null, closeForm = null }) => {
  ...
  const [manualData, setManualData] = useState({ firma: "", artikelnr: "", orderNumber: "" });
  ...
  const resetState = () => {
    ...
    setStatus("");
    setManualData({ firma: "", artikelnr: "", orderNumber: "" });
  };
  ...
  const handleCheck = (section, label) => {
    setFormData((prev) => {
      ...
      return { ...prev, [section]: { ...prev[section], checks } };
    });
  };

  const handleRemark = (section, text) => {
    setFormData((prev) => ({ ...prev, [section]: { ...prev[section], remarks: text } }));
  };
    ...
    <div className="modal-overlay">
      <div className="modal-content" ref={modalRef}>
        <form className="stichprobe-form" onSubmit={handleSubmit}>
              ...
              {clickedItem ? (
                ...
                <>
                  <input
                    ...
                    onChange={(e) =>
                      setManualData((prev) => ({ ...prev, firma: e.target.value }))
                    }
                  />
                  <input
                    type="text"
                    ...
                    required
                    onChange={(e) =>
                      setManualData((prev) => ({ ...prev, artikelnr: e.target.value }))
                    }
                  />
                  <input
                    type="text"
                    ...
                    onChange={(e) =>
                      setManualData((prev) => ({ ...prev, orderNumber: e.target.value }))
                    }
                  />
                </>
              )}
          ...
          {/* Your original sections restored */}
          <Section
            title="Allgemein"
